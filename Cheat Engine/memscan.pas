  ...
  begin
    ...
    begin
      ...
      begin
        ...
        messagedlg('The scan was forced to terminate. Subsequent scans may not function properly. It''s recommended to restart MyCheat', mtWarning, [mbok], 0);
...
begin
  ...
  fScanResultFolder:=usedtempdir+'MyCheat'+pathdelim;
...
begin
  ...
  begin
    try
      ...
      if FindFirst(usedtempdir+'MyCheat\{*}',  faDirectory , info)=0 then
      begin
        repeat
          ...
          begin
            ...
            begin
              ...
              f:=usedtempdir+'MyCheat\'+info.name;
