    ...
    //  usealternatedebugmethod:=false;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if iswow64 then
              begin
                ShowMessage('Please run the 64-bit version of MyCheat');
                exit;
              end;
              {$endif}
        ...
        begin
          ...
          begin
            closehandle(hdevice);
            messagebox(0,'The driver that is currently loaded belongs to a different version of MyCheat. Please unload this driver or reboot.','DBK32.dll',MB_ICONERROR or MB_OK);
