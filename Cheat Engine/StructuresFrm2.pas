...
uses
  ...
  StdCtrls, ComCtrls, Menus, lmessages, scrolltreeview, byteinterpreter, symbolhandler, MCFuncProc,
...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsWrongVersion = 'This structure file was generated with a newer version of '
     +'MyCheat. (That means there''s more than likely a new version so '
     +'please update....)';
...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\MyCheat\DissectData',false) then
    begin
