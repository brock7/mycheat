...
resourcestring
  ...
  rsPleaseTargetAnotherProcess = 'Start another version of MyCheat and attach to that instead';
...
begin
  ...
  try
    if reg.OpenKey('\Software\MyCheat\Disassemblerview\',true) then
    begin
...
begin
  ...
  reg:=Tregistry.Create;
  try
    if reg.OpenKey('\Software\MyCheat\Disassemblerview\',false) then
    begin
