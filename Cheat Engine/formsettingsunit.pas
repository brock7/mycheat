  ...
  try
    ...
    begin
      ...
      try
        ...
        //save the hotkeylist
        reg.WriteBinaryData('Show MyCheat Hotkey',frameHotkeyConfig.newhotkeys[0][0],10);
...
{$ifndef net}
    ...
    reg.DeleteKey('\Software\MyCheat\Tools');
    if Reg.OpenKey('\Software\MyCheat\Tools',true) then
    begin
    ...
    //save the plugins
    reg.DeleteKey('\Software\MyCheat\Plugins'+cpu);
    if Reg.OpenKey('\Software\MyCheat\Plugins'+cpu,true) then
    begin
