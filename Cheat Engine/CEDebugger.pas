...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfCheatEngineToTheCurrent = 'This will attach the debugger of MyCheat to the current process.';
  rsDoNotCloseCE = 'If you close MyCheat while the game is running, the game will close too. Are you sure you want to do this?';
  rsContinue = 'Continue?';
